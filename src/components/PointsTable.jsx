        ...
        <>
            ...
            <div className='row p-0'>
                <div className="row m-0 p-0 py-2 px-2 fw-bold bg-gray">
                    <p className='col-4 m-0 p-0 fs-7'>Team</p>
                    <div className="col-8 m-0 p-0 d-flex fs-7">
                ...
                {pointsTable && pointsTable.map((t) => (
                    <div className="row m-0 p-0 py-2 px-2 border-bottom border-2">
                        <p className='col-4 fw-semibold m-0 p-0 text-truncate fs-7 d-flex align-items-center'><img className='me-1' style={{ height: "2rem" }} src={teams[t.teamId - 1].logo} alt={teams[t.teamId - 1].name} />{teams[t.teamId - 1].shortName}</p>
                        <div className="col-8 m-0 p-0 d-flex align-items-center">
