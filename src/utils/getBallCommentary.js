function getBallCommentary(ballOutcome) {
    ...
    if (ballOutcome == 0) {
        return commentaryForDotBall[Math.floor(Math.random() * commentaryForDotBall.length)];
    }
    else if (ballOutcome == 1) {
        return commentaryForSingleRun[Math.floor(Math.random() * commentaryForSingleRun.length)];
    }
    else if (ballOutcome == 2) {
        return commentaryForDoubleRun[Math.floor(Math.random() * commentaryForDoubleRun.length)];
    }
    else if (ballOutcome == 3) {
        return commentaryForTripleRun[Math.floor(Math.random() * commentaryForTripleRun.length)];
    }
    else if (ballOutcome == 4) {
        return commentaryForFourRun[Math.floor(Math.random() * commentaryForFourRun.length)];
    }
    else if (ballOutcome == 5) {
        return commentaryForCaughtOut[Math.floor(Math.random() * commentaryForCaughtOut.length)];
    }
    else if (ballOutcome == 6) {
        return commentaryForSixRun[Math.floor(Math.random() * commentaryForSixRun.length)];
    }
    else if (ballOutcome == 7) {
        return commentaryForWideBall[Math.floor(Math.random() * commentaryForWideBall.length)];
    }
}
export default getBallCommentary;